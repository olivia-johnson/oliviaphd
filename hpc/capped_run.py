...
with open('/hpcfs/users/a1704225/parameters/capped/{0}.txt'.format(params), 'r') as f:
...
####  SIMULATE SEGLIFT
seglift_hpc.simulate_seglift_cap(tmpdir, group, sim_run, recRate, nChrom, chromSize, s_pop, w_pop, l, y, d, rGen, fitness_on, sum_gen, win_gen, offCap)
