...
with open('/hpcfs/users/a1704225/parameters/background_mfit/{0}.txt'.format(params), 'r') as f:
...
####  SIMULATE SEGLIFT
seglift_hpc.simulate_seglift_mfit(tmpdir, slim_sim, group, sim_run, recRate, nChrom, chromSize, s_pop, w_pop, l, y, d, rGen, fitness_on, sum_gen, win_gen)
